...
public strictfp enum OwnableSatelliteType {
	...
	final public String namePlanet;
	final public int initial_pop;
	final public double PopGrowthRate;
	final public int pop_capacity;
	final public int building_Num;
	final public double mining_rate;
