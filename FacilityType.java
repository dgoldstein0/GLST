...
public strictfp enum FacilityType
{
	...
	TAXOFFICE 			("Tax Office",			200,	200,	10001,		"images/TaxOffice.gif",			"Taxes population for income",									new FacilityCreator<TaxOffice> () {public TaxOffice create(OwnableSatellite<?> o, int i, long t){return new TaxOffice(o,i,t);}});
